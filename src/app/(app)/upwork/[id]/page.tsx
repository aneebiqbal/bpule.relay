      ...
      <section className="rounded-2xl border border-line bg-paper p-6">
        ...
        <div className="mt-4 flex items-baseline gap-3">
          ...
          <span className="ml-2 rounded-full px-2.5 py-0.5 text-xs font-medium
            {score.verdict === 'apply' ? 'bg-status-send/10 text-status-send' : score.verdict === 'apply_if_connects' ? 'bg-status-research/10 text-status-research' : 'bg-line/50 text-slate'}">
