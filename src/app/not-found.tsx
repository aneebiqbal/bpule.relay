...
export default function NotFound() {
  return (
    <div className="flex min-h-dvh flex-col items-center justify-center gap-6 px-6 text-center gradient-mesh">
      <div className="pointer-events-none absolute -top-32 left-1/2 -translate-x-1/2 size-64 rounded-full bg-gold/[0.08] blur-[80px]" />
      <div className="relative">
        ...
        <Link
          href="/"
          className="mt-6 inline-flex items-center gap-2 rounded-2xl bg-ink px-6 py-3 text-sm font-medium text-paper transition-all duration-300 hover:bg-ink/90 hover:shadow-lg active:scale-[0.97]"
        >
