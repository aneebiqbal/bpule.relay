...
export default function SignupPage() {
  ...
  async function signup(e: React.FormEvent) {
    ...
    try {
      ...
      // The account can't sign in until the email is confirmed — show a
      // confirmation screen instead of attempting to auto-sign-in.
          ...
          {confirmationSent ? (
            <>
              <div className="space-y-2">
                <h1 className="text-heading text-3xl text-ink">Check your email</h1>
                <p className="text-[15px] leading-relaxed text-slate">
                  We sent a confirmation link to <span className="font-medium text-ink">{email.trim()}</span>.
                  Click it to activate your account, then sign in below.
                </p>
              </div>
              <div className="rounded-2xl border border-line/60 bg-bg-bone-raised p-6">
